      ...
      <main className="max-w-[1200px] mx-auto px-6 py-10">
        ...
        <section className="grid md:grid-cols-2 gap-8 items-center min-h-[520px]">
          <div>
            ...
            <p className="mt-4 text-lg text-gray-700 max-w-lg">
              Lightweight, durable trolleys built for frequent travelers. Lifetime wheel warranty & 30-day returns.
            </p>
            <div className="mt-6 flex gap-4">
              ...
              <Link href="/compare" legacyBehavior>
                <a className="px-6 py-3 rounded-lg border border-gray-300">Compare models</a>
              </Link>
            </div>
          </div>
        ...
        <section className="mt-12">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/shop" legacyBehavior>
              <a className="text-sm text-brand-accent">See all</a>
            </Link>
          </div>
